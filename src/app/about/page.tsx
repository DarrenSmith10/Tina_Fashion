  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <p className="text-gray-700 mb-4">
        ...
        With a background in fashion and textile design, she has a keen eye for detail and a unique approach to creating vibrant and innovative designs. Tina's work is inspired by nature, culture, and the world around her, resulting in captivating patterns and textures that bring life to fabrics.
      </p>
